...
# key ရော value ရောသုံးချင်ရင် items() ကို သုံးပေးရမယ် 
...
print(f"Outside j value is {j}") # Outside i value is 9
...
print(enumerate(paints)) # <enumerate object at 0x0000020183CD2740>
